...
class NavigationManager {
    ...
    setupMenuItems() {
        this.menuItems = [
            { id: 'dashboard', label: 'ダッシュボード', path: '#/dashboard', roles: ['developer', 'admin', 'evaluator', 'worker'] },
            ...
            // ▼▼▼ 開発者ページ用のメニュー項目を追加 ▼▼▼
            { id: 'developer', label: '開発者ページ', path: '#/developer', roles: ['developer'] }
        ];
    }
        ...
        return `
            <div class="header-content">
                <div class="pc-nav-elements">
                    <div class="logo">
                        <a href="#/dashboard"><h1>評価システム</h1></a>
                    </div>
    ...
    renderUserInfo() {
        const roleNames = { developer: '開発者', admin: '管理者', evaluator: '評価者', worker: '作業員' };
