...
async function viewEvaluation(id) {
    ...
    try {
        ...
        if (polygonChartData.length > 0) new PolygonChart('detail-polygon-chart', quantitativeItems, polygonChartData);
        if (barChartData.length > 0) new BarChart('detail-bar-chart', barChartData);
